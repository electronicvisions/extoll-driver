...
void set_extoll_rf_np_top_rf_n0_ln_raw(long unsigned int value);
long unsigned int get_extoll_rf_np_top_rf_n0_ln_raw(void);
...
void set_extoll_rf_np_top_rf_n1_ln_raw(long unsigned int value);
long unsigned int get_extoll_rf_np_top_rf_n1_ln_raw(void);
...
void set_extoll_rf_np_top_rf_n2_ln_raw(long unsigned int value);
long unsigned int get_extoll_rf_np_top_rf_n2_ln_raw(void);
...
void set_extoll_rf_np_top_rf_n3_ln_raw(long unsigned int value);
long unsigned int get_extoll_rf_np_top_rf_n3_ln_raw(void);
...
void set_extoll_rf_nw_phy_rf_link_ctrl(long unsigned int index_inst, long unsigned int value);
long unsigned int get_extoll_rf_nw_phy_rf_link_ctrl(long unsigned int index_inst);
